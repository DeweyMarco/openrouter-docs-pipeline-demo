...
async function run() {
  const result = await mintlifyDemo.beta.responses.send({
    body: {
...
import { betaResponsesSend } from "mintlify-demo/funcs/beta-responses-send.js";
...
async function run() {
  const res = await betaResponsesSend(mintlifyDemo, {
    body: {
      input: "Tell me a joke",
      model: "openai/gpt-4o",
    },
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.CreateResponsesRequest](../../models/operations/create-responses-request.md)                                                                                       | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[operations.CreateResponsesResponse](../../models/operations/create-responses-response.md)\>**
