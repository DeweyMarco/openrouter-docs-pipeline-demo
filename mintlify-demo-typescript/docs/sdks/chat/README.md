...
async function run() {
  const result = await mintlifyDemo.chat.send({
    body: {
      messages: [
        {
          role: "system",
...
import { chatSend } from "mintlify-demo/funcs/chat-send.js";
...
async function run() {
  const res = await chatSend(mintlifyDemo, {
    body: {
      messages: [
        {
          role: "system",
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.SendChatCompletionRequestRequest](../../models/operations/send-chat-completion-request-request.md)                                                                 | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[operations.SendChatCompletionRequestResponse](../../models/operations/send-chat-completion-request-response.md)\>**
