...
async function run() {
  const result = await mintlifyDemo.credits.getCredits();
...
import { creditsGetCredits } from "mintlify-demo/funcs/credits-get-credits.js";
...
async function run() {
  const res = await creditsGetCredits(mintlifyDemo);
  if (res.ok) {
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetCreditsRequest](../../models/operations/get-credits-request.md)                                                                                                 | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
